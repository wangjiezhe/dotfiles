...
class VersionInformation(Magics):
    ...
    def _repr_html_(self):
        ...
        try:
            ...
            html += "<tr><td colspan='2'>%s</td></tr>" %                 time.strftime(timefmt).decode(_date_format_encoding())
        html += "</table>"
    ...
    def _repr_latex_(self):
        ...
        try:
            latex += r"\hline \multicolumn{2}{|l|}{%s} \ \hline" %                 time.strftime(timefmt) + "\n"
        except:
            latex += r"\hline \multicolumn{2}{|l|}{%s} \ \hline" %                 time.strftime(timefmt).decode(_date_format_encoding()) + "\n"
    ...
    def _repr_pretty_(self, pp, cycle):
        ...
        try:
            ...
            text += "%s" %                 time.strftime(timefmt).decode(_date_format_encoding())
